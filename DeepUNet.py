...
def down_block(inputs, num_filters, format='channels_last'):
...
def up_block(act, bn, num_filters, format='channels_last'):
...
def get_model(input_size, batch_size, format='channels_last'):
    ...
    model = Model(inputs=nn_in, outputs=score1, name="DeepUNet")
