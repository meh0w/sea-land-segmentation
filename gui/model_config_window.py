...
class Model_Config_Window(QMainWindow):
    def __init__(self, parent, training):
        ...
        layout.addWidget(self.NDWI_cbox, 1, 1)
        layout.addWidget(self.scale_cbox, 2, 1)
        layout.addWidget(self.ablation_cbox, 3, 1)
        layout.addWidget(self.amm_cbox, 4, 1)

        layout.addWidget(self.model_label, 0, 0)
        # layout.addWidget(self.precision_label, 1, 0)
        layout.addWidget(self.NDWI_label, 1, 0)
        layout.addWidget(self.scale_label, 2, 0)
        layout.addWidget(self.ablation_label, 3, 0)
        layout.addWidget(self.amm_label, 4, 0)
        ...
        if self.training:
            ...
            layout.addWidget(self.epochs_sbox, 5, 1)
            layout.addWidget(self.batchsize_sbox, 6, 1)
            layout.addWidget(self.lrate_sbox, 7, 1)
            layout.addWidget(self.train_part_sbox, 8, 1)
            layout.addWidget(self.scheduler_cbox, 9, 1)
            layout.addWidget(self.debug_cbox, 10, 1)
            layout.addWidget(self.dataset_cbox, 11, 1)
            layout.addWidget(self.loss_cbox, 12, 1)
            layout.addWidget(self.optimizer_cbox, 13, 1)
            # layout.addWidget(self.momentum_sbox, 14, 1)
            # layout.addWidget(self.weight_decay_sbox, 15, 1)
            layout.addWidget(self.eval_freq_sbox, 14, 1)

            layout.addWidget(self.epochs_label, 5, 0)
            layout.addWidget(self.batchsize_label, 6, 0)
            layout.addWidget(self.lrate_label, 7, 0)
            layout.addWidget(self.train_part_label, 8, 0)
            layout.addWidget(self.scheduler_label, 9, 0)
            layout.addWidget(self.debug_label, 10, 0)
            layout.addWidget(self.dataset_label, 11, 0)
            layout.addWidget(self.loss_label, 12, 0)
            layout.addWidget(self.optimizer_label, 13, 0)
            # layout.addWidget(self.momentum_label, 14, 0)
            # layout.addWidget(self.weight_decay_label, 15, 0)
            layout.addWidget(self.eval_freq_label, 14, 0)
        else:
            ...
            layout.addWidget(self.outputs_cbox, 5, 1)
            layout.addWidget(self.outputs_label, 5, 0)
            layout.addWidget(self.dataloader_cbox, 6, 1)
            layout.addWidget(self.dataloader_label, 6, 0)
